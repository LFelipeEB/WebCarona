...
final class Connection {
	 ...
	 *
	 * @param nome do tipo de banco a ser criado. (MySQL)
	...
	public static function open($banco) {
		switch (strtoupper ( $banco )) {
			case 'MYSQL' :
				if (file_exists ( "/home/lfelipeeb/git/WebCarona/Serve1.0/Configure/ini/mysql.ini" )) {
					$db = parse_ini_file ( 'ini/mysql.ini' );
				} else {
